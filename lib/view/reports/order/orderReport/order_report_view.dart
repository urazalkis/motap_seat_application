...
import 'package:motaperp_seat_application/core/widget/alertDialog/alert_dialog_detail.dart';
...
import 'package:motaperp_seat_application/view/reports/order/orderReport/order_report_state.dart';
...
class _OrderReportViewState extends State<OrderReportView> {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<OrderReportCubit>
      (
        viewModel: OrderReportCubit(),
      init: (viewModel) {
      ...
      dispose: (viewModel){
        ...
        onPageBuilder:(BuildContext context, OrderReportCubit viewModel) => Scaffold(
          appBar: AppBar(
          centerTitle: true,
          ...
          const Text("Sipariş Raporu",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)
              :
          TextFieldStandard(
              ...
              onPressed: () {
                if(baseReportViewModel.selectedData==null){
                  ...
                  if (baseReportViewModel.selectedDateMin == null ||
                    ...
                    context.read<OrderReportCubit>().getOrderListWithFilter(baseReportViewModel.selectedData,
                           ...
                           BlocBuilder<OrderReportCubit,IOrderReportState>
                             (
                               builder: (context,orderReportState){
                                 if(orderReportState is EmployeePaymentLoading)
                                 {

                                   return const CustomCircularProgressIndicator();

                                 }
                                 else if(orderReportState is EmployeePaymentLoaded)
                                 {
                                   return Flexible(
                                           ...
                                           SingleChildScrollView(
                                             ...
                                             child: SingleChildScrollView(
                                               ...
                                               child: CustomDataTable(
                                                 dataList: orderReportState.myList ?? [],
                                                 ...
                                                 rows: List<DataRow>.generate(
                                                     orderReportState.myList!.length,
                                                         (index) =>
                                                         DataRow(
                                                             onSelectChanged: (a) {
                                                               print("tıklandı");
                                                             ...
                                                             cells: [
                                                               ...
                                                               DataCell(Text(
                                                                   "${orderReportState.myList![index]!
                                                                       .modelName}")),
                                                               DataCell(Text(
                                                                   "${orderReportState.myList![index]!.type}")),
                                                               DataCell(Text(
                                                                   "${orderReportState.myList![index]!
                                                                       .orderDate}")),
                                                               DataCell(Text(
                                                            ...
                                                            [
                                                              PopupMenuItem(
                                                                ...
                                                                child: TextButton.icon(
                                                                  icon: Icon(Icons.search,color: ColorConstants.instance.customBlueColor,),
                                                                  ...
                                                                  onPressed: () {
                                                                    showDialog(
                                                                        ...
                                                                        builder: (BuildContext context){
                                                                          return AlertDialogDetail(
                                                                              text: "Sipariş Özet Detayı",
                                                                              items: [
                                 ...
                                 else if(orderReportState is EmployeePaymentError)
                                 {
