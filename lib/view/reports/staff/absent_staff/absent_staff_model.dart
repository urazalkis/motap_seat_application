...
class AbsentStaffModel extends IBaseModel<AbsentStaffModel>{
  RegisterModel registerModel;
  String? searchedData;

  AbsentStaffModel(this.registerModel,this.searchedData);
  ...
  @override
  AbsentStaffModel fromJson(Map<String, dynamic> json) {
